...
import com.example.cart.adapter.SearchAdapter;
import com.example.cart.bean.SearchBean;
import com.example.cart.presenter.SearchPresenter;
import com.example.cart.view.SearchViewListener;
...
public class SearchActivity extends AppCompatActivity implements SearchViewListener {
    ...
    @OnClick({R.id.fanhui, R.id.search_text, R.id.search_edit, R.id.sousuo_recyview})
